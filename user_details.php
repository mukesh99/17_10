						...
						<?php
							...
							while($row = $result->fetch_assoc()) {
							  ...
							  echo "<tr>"; 
								...
								echo"<td><select name='select' id='select' value='".$row['user_permission']."'><option value=''>".$row['user_permission']."</option><option value='administrator'>Administrator</option><option value='paiduser'>Paid User</option></select></td>";
								echo"<td><a class='btn btn-success' href='user_update.php?id=".$row['id']."'>update</a></td>";
